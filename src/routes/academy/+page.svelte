<script lang="ts">
  ...
  const errors = $derived({
    name:
      touched.name && name.trim().length < 2 ? "Nama minimal 2 karakter" : "",
    email:
      touched.email && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)
        ? "Email tidak valid"
        : "",
    organization:
      touched.organization && organization.trim().length < 2
        ? "Nama organisasi diperlukan"
        : "",
    engagementType:
      touched.engagementType && !engagementType ? "Pilih jenis undangan" : "",
    description:
  ...
  async function handleSubmit(e: SubmitEvent) {
    ...
    const typeLabel =
      engagementTypes.find((t) => t.value === engagementType)?.label ??
      engagementType;
    const lines = [
      `Nama: ${name}`,
      `Email: ${email}`,
  ...
  const credentials = [
    ...
    {
      icon: "🎓",
      text: "Grade 11, Software Engineering — IDN Boarding School",
    },
  ...
  const steps = [
    {
      n: "01",
      title: "Isi Form",
      desc: "Kirim detail acara, proyek, atau kebutuhan kamu lewat form di bawah.",
    },
    {
      n: "02",
      title: "Review 24 Jam",
      desc: "Aku review dan membalas dalam 1×24 jam kerja.",
    },
    {
      n: "03",
      title: "Diskusi Singkat",
      desc: "Kita jadwalkan call 15–30 menit untuk align ekspektasi & detail.",
    },
    {
      n: "04",
      title: "Mulai!",
      desc: "Deal, tandatangani brief, dan kolaborasi dimulai.",
    },
  ];
</script>
...
<svelte:head>
  ...
  <meta
    name="description"
    content="Hire Iqbal Muhammad Adiatma as a speaker, freelance developer, or workshop facilitator. Send your invitation or project brief."
  />
</svelte:head>
  ...
  <section class="hero">
    ...
    <div class="hero-inner">
      <div class="hero-content">
        ...
        <Reveal delay={60}>
          <h1 class="hero-title">
            Hire Me or<br /><span class="hero-accent">Invite as Speaker</span>
          </h1>
        </Reveal>

        <Reveal delay={120}>
          <p class="hero-desc">
            Butuh developer full-stack, pembicara teknologi, atau fasilitator
            workshop? Aku siap berkolaborasi untuk membawa <span
              class="hero-highlight">dampak nyata</span
            > bagi instansi atau proyekmu.
          </p>
        </Reveal>
      ...
      <Reveal delay={80}>
        <div class="hero-photos">
          <div class="hero-photo photo-sm">
            <img
              src="/images/amikom-presentasi.jpg"
              alt="Sesi Presentasi Amikom"
            />
          </div>
  ...
  <section class="section">
    <Reveal>
      <div class="section-hd">
        ...
        <p class="section-sub">
          Beberapa dokumentasi dari kegiatan, seminar, dan kolaborasi yang
          pernah aku lakukan.
        </p>
      </div>
    </Reveal>
    ...
    <Reveal delay={60}>
      ...
      <div class="gallery-r1">
        <div class="gallery-item gitem-feature">
          <img
            src="/images/amikom-landscape.jpg"
            alt="Event Amikom"
            loading="lazy"
            decoding="async"
          />
          <div class="gallery-caption">
            Speaker — Universitas Amikom Yogyakarta
          </div>
        </div>
        <div class="gallery-col">
          ...
          <div class="gallery-item">
            <img
              src="/images/amikom-fotbar.jpg"
              alt="Foto Bersama Amikom"
              loading="lazy"
              decoding="async"
            />
    ...
    <Reveal delay={80}>
      ...
      <div class="gallery-r2">
        <div class="gallery-item">
          <img
            src="/images/smk-muh-guru.jpg"
            alt="Mengajar Guru SMK Muhammadiyah"
            loading="lazy"
            decoding="async"
          />
        ...
        <div class="gallery-item">
          <img
            src="/images/smk-muh-kelas.jpg"
            alt="Kelas SMK Muhammadiyah"
            loading="lazy"
            decoding="async"
          />
    ...
    <Reveal delay={100}>
      ...
      <div class="gallery-r3">
        <div class="gallery-item">
          <img
            src="/images/with-dr-joan-santoso.jpg"
            alt="Bersama Dr. Joan Santoso"
            loading="lazy"
            decoding="async"
          />
        ...
        <div class="gallery-item">
          <img
            src="/images/with-prof-esther.jpg"
            alt="Bersama Prof. Esther"
            loading="lazy"
            decoding="async"
          />
        ...
        <div class="gallery-col">
          <div class="gallery-item">
            <img
              src="/images/undip-fotobersama.jpg"
              alt="Foto Bersama Undip"
              loading="lazy"
              decoding="async"
            />
    ...
    <Reveal delay={120}>
      ...
      <div class="gallery-r4">
        <div class="gallery-item gitem-banner">
          ...
          />
          <div class="gallery-caption">
            Behind the Scene — Studio & Workshop
          </div>
        </div>
        <div class="gallery-col">
          <div class="gallery-item">
            <img
              src="/images/msw-pertama.jpg"
    ...
    <Reveal delay={100}>
      <div class="exp-chips">
        {#each [{ icon: "🎤", label: "Public Speaker", desc: "5+ instansi" }, { icon: "💻", label: "Freelance Dev", desc: "10+ proyek" }, { icon: "🏫", label: "Workshop", desc: "3+ batch" }, { icon: "🏆", label: "Kompetisi", desc: "Finalis nasional" }, { icon: "📜", label: "Sertifikasi", desc: "33 sertifikat" }, { icon: "🎓", label: "Akademik", desc: "GPA 5.0" }] as chip}
          <div class="exp-chip">
  ...
  <section class="section">
    <Reveal>
      <div class="section-hd">
        ...
        <h2>Project Kita</h2>
        <p class="section-sub">
          Beberapa proyek yang telah aku kerjakan untuk berbagai klien dan
          kebutuhan bisnis.
        </p>
      </div>
    </Reveal>
          ...
          <a href="/projects/{project.slug}" class="project-card">
            ...
            <div class="project-content">
              <div class="project-meta">
                {#if project.year}<span class="project-year"
                    >{project.year}</span
                  >{/if}
                {#if project.featured}<span class="project-badge"
                    >★ Featured</span
                  >{/if}
                {#if project.status}<span class="project-status"
                    >{project.status}</span
                  >{/if}
              </div>
      ...
      {#each services as svc, i}
        <Reveal delay={i * 80}>
          <div class="svc-card" style="--c: {svc.color}">
            <div
              class="svc-icon-wrap"
              style="color:{svc.color}; background:{svc.color}15; border:1px solid {svc.color}25"
            >
              {@html svc.icon}
            </div>
            <h3>{svc.title}</h3>
    ...
    <Reveal>
      <div class="section-hd">
        ...
        <p class="section-desc">
          Isi form di bawah dengan detail lengkap. Aku akan merespons dalam <strong
            >1×24 jam kerja</strong
          >.
        </p>
      </div>
    </Reveal>
        ...
        <div class="form-card">
          {#if status === "sent"}
            <div class="success-state">
              ...
              <p>
                WhatsApp kamu sudah terbuka dengan draft pesan. Kirim chat-nya
                untuk menyelesaikan proses undangan.
              </p>
              <p class="success-note">
                Belum terbuka? Chat langsung ke <a
                  href="https://wa.me/6281232588596"
                  target="_blank"
                  rel="noopener noreferrer">+62 812-3258-8596</a
                >
              </p>
              <button class="btn-reset" onclick={() => (status = "idle")}
                >Kirim Lagi</button
              >
            </div>
          {:else}
            <form onsubmit={handleSubmit} novalidate>
              <div class="form-row">
                <div class="field" class:has-error={errors.name}>
                  <label for="f-name"
                    >Nama Lengkap <span class="req">*</span></label
                  >
                  <input
                    id="f-name"
                    type="text"
                ...
                <div class="field" class:has-error={errors.email}>
                  ...
                  />
                  {#if errors.email}<span class="field-error"
                      >{errors.email}</span
                    >{/if}
                </div>
              </div>
              ...
              <div class="form-row">
                <div class="field">
                  <label for="f-phone"
                    >No. HP / WhatsApp <span class="opt">(opsional)</span
                    ></label
                  >
                  <input
                    id="f-phone"
                ...
                <div class="field" class:has-error={errors.organization}>
                  <label for="f-org"
                    >Nama Instansi / Organisasi <span class="req">*</span
                    ></label
                  >
                  <input
                    id="f-org"
                  ...
                  />
                  {#if errors.organization}<span class="field-error"
              ...
              <div class="field" class:has-error={errors.engagementType}>
                <label for="f-type"
                  >Jenis Undangan <span class="req">*</span></label
                >
                <div class="type-grid">
                  {#each engagementTypes as t}
                    <button
                      ...
                      onclick={() => {
                        ...
                        touched.engagementType = true;
                      }}>{t.label}</button
                    >
                  {/each}
                </div>
                {#if errors.engagementType}<span class="field-error"
                    >{errors.engagementType}</span
                  >{/if}
              </div>
              ...
              <div class="form-row">
                <div class="field">
                  <label for="f-event"
                    >Nama Acara / Proyek <span class="opt">(opsional)</span
                    ></label
                  >
                  <input
                    id="f-event"
                    ...
                    placeholder="Seminar Teknologi 2026 / Project X"
                  />
                </div>
                <div class="field">
                  <label for="f-date"
                    >Tanggal Rencana <span class="opt">(opsional)</span></label
                  >
              ...
              <div class="field">
                ...
                <div class="format-row">
                  {#each [["online", "Online"], ["offline", "Offline"], ["hybrid", "Hybrid"]] as [val, lbl]}
                    <label
                      class="radio-label"
                      class:active={eventFormat === val}
                    >
                      <input
                        type="radio"
                        bind:group={eventFormat}
                        value={val}
                      />
                      {lbl}
                    </label>
              ...
              <div class="field" class:has-error={errors.description}>
                <label for="f-desc"
                  >Detail / Deskripsi <span class="req">*</span></label
                >
                <textarea
                  id="f-desc"
                ...
                <div class="field-foot">
                  {#if errors.description}<span class="field-error"
                      >{errors.description}</span
                    >{/if}
                  <span
                    class="char-count"
                    class:warn={description.length > 0 &&
                      description.length < 20}
                    >{description.length} / min 20</span
                  >
                </div>
              </div>
              ...
              <div class="field">
                <label for="f-budget"
                  >Estimasi Budget <span class="opt">(opsional)</span></label
                >
                <input
                  id="f-budget"
                  type="text"
                  bind:value={budget}
                  placeholder="Rp 500.000 — Rp 5.000.000 / Negotiable"
                />
              </div>
      ...
      <Reveal direction="right" delay={100}>
        <div class="form-sidebar">
          ...
          <div class="contact-quick">
            ...
            <a
              href="mailto:iqbalmuhammadadiatma@gmail.com"
              class="contact-link"
            >
              <span class="contact-icon">
                <svg
            ...
            <a
              href="https://www.linkedin.com/in/iqbaladiatma"
              target="_blank"
              rel="noopener noreferrer"
              class="contact-link"
            >
          ...
          <div class="avail-card">
            ...
            <div>
              ...
              <span class="avail-sub"
                >Freelance · Speaker · Workshop · Mentoring</span
              >
            </div>
          </div>
        </div>
...
<style>
  ...
  :global([data-theme="dark"]) .pulse-dot {
    background: #4ade80;
  }
  ...
  :global([data-theme="dark"]) .avail-pulse {
    background: #4ade80;
  }
